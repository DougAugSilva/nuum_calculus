...
- `bin/`: Compiled program code, automatically generated when running the tests.
- `data/`: Data generated by the programs, used for plotting graphs and printing results.
- `include/`: Header files containing declarations of functions, variables, macros, and data types.
- `outputs/`: Results of the test files, contains examples of applications of the methods.
- `src/`: Source files where the numerical methods themselves are implemented.
- `test/`: Tests designed to illustrate the use of the methods in selected case studies.
